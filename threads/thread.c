...
/** thread를 blocked 상태로 만들고 sleep_queue에 삽입하여 대기 */
...
/** sleep_queue에서 깨워야 할 thread를 찾아서 wake */
...
/** sleep_list에서 가장 작은 wakeup_ticks를 갱신 */
...
/** 우선순위를 비교하고 ready_list에서 가장 높은 것을 기반으로 스케줄링 */
